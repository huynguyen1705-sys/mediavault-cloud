      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-500/10 border border-violet-500/20 rounded-full text-violet-400 text-sm font-medium mb-8">
            ...
            Cloud Media Storage Reimagined
          </div>
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            ...
            expiring links, and embedded players. All with signed URLs and anti-hotlink protection.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/register"
              className="px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-xl flex items-center gap-2 transition-all"
            >
            ...
            <div className="bg-gradient-to-r from-violet-500/20 to-purple-500/20 rounded-2xl p-1">
              <div className="bg-gray-900 rounded-xl p-6">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-sm text-gray-500">MediaVault Dashboard</span>
                </div>
      ...
      <section className="py-20 px-4 bg-gray-900/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Professional media storage for individuals and teams</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-6 bg-gray-900 border border-gray-800 rounded-2xl hover:border-violet-500/50 transition-colors"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {plans.map((plan) => (
              ...
              >
                {plan.popular && (
                  <span className="inline-block px-3 py-1 bg-violet-500 text-white text-xs font-semibold rounded-full mb-4">
                    Most Popular
                  </span>
                )}
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg mb-8">
            Join thousands of users who trust MediaVault for their media storage needs.
          </p>
          <Link
            href="/register"
            className="inline-flex items-center gap-2 px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-xl transition-all"
          >
