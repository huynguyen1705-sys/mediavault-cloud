...
import { Cloud, Menu, X, Sun, Moon, LayoutDashboard, FolderOpen, BarChart3, Settings, ScrollText, Home, Sparkles, CreditCard, Shield, Calendar, MessageCircle } from "lucide-react";
...
export default function Navbar() {
  ...
  const dashboardLinks = [
    ...
    { href: "/chat", label: "AI Chat", icon: MessageCircle, color: "text-cyan-400" },
